export function parseIntegerOption(value, name, defaultValue, options = {}) {
...
export function validateDateOption(value, name) {
...
export function parseUnixTimestampOption(value, name) {
    if (!/^\d+$/.test(value)) {
