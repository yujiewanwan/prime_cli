...
async function editForm(prompt, referenceImagePath) {
    let content;
    try {
    ...
    form.append("referenceImage", new Blob([new Uint8Array(content)], { type: "application/octet-stream" }), basename(referenceImagePath));
    return form;
}
